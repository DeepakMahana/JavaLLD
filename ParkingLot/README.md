...
- **parkinglot.main.ParkingLot:** Main class managing the entire parking lot, floors, and overall operations.
...
- **Singleton Pattern:** (If used) For parkinglot.main.ParkingLot instance.
...
```java
import parkinglot.main.ParkingLot;

ParkingLot lot = new ParkingLot();
lot.

addFloor(new ParkingFloor(...));
Ticket parkingTicket = lot.parkVehicle(new Car("KA-01-1234"));
lot.

unparkVehicle(parkingTicket.getId());
```
